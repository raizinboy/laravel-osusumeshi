...
<div class="container mb-5">
    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-12 fs-5 mt-1 mb-2">
            <a href="{{ route('top') }}">TOP</a><span class="ms-2 me-1">></span><a class="mt-1" href="{{ route('mypage', Auth::user()->id) }}">マイページ</a><span class="ms-2 me-1">></span><span>共感した投稿一覧</span>
        </div>
        <h1 class="display-3 ps-1 ms-3 col-md-10 d-md-block d-none"><span class="fs-2 mb-3 me-1">{{ Auth::user()->name }}さんの</span>共感した投稿一覧 </h1>
        <h2 class="ms-3 fs-3 col-12 d-md-none d-block">{{ Auth::user()->name }}さんの</h2>
        <h2 class="ms-3 fs-3 col-12 d-md-none d-block"> 共感した投稿一覧 </h2>
