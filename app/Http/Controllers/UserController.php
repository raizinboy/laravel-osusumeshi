...
class UserController extends Controller
{
    public function mypage($id)
    {
        ...
        $posts = Post::where('user_id', $id)->sortable()->paginate(10);
    ...
    public function show_ikitai()
    {
        ...
        $posts = Post::whereIn('id', $ikitai_post_ids)->with('prefecture','user')->sortable()->paginate(10);
    ...
    public function show_empathy()
    {
        ...
        $posts = Post::whereIn('id', $empathy_post_ids)->with('prefecture','user')->sortable()->paginate(10);
